...
import { BaseSelectAdv } from "@/components/shared/inputs/BaseSelectAdv";
                    ...
                    <Form className="flex flex-col gap-5">
                        ...
                        <div className="w-full">
                                ...
                                <div className="flex-1 flex flex-col gap-3 w-full">
                                    ...
                                    <div className="flex flex-col sm:flex-row gap-3">
                                        <div className="flex-1 flex flex-col gap-1">
                                            ...
                                            <BaseInput
                                                label=""
                                                name="buildingDetails.officeTelephone"
                                                required
                                                placeholder="+966 2456 7890"
                                                className="[&>label]:hidden"
                                            />
                                        </div>
                                        ...
                                        <div className="flex-1 flex flex-col gap-1">
                                            ...
                                            <BaseInput
                                                label=""
                                                name="buildingDetails.officeFax"
                                                placeholder="+966 2456 7891"
                                                className="[&>label]:hidden"
                                            />
                                        </div>
                                    </div>
                                    ...
                                    <div className="flex flex-col gap-1">
                                        ...
                                        <BaseInput
                                            label=""
                                            name="buildingDetails.email"
                                            type="email"
                                            placeholder="info@companya.com"
                                            className="[&>label]:hidden"
                                        />
                                    </div>
                                </div>
                            ...
                            <div className="flex flex-col md:flex-row items-start gap-4">
                                ...
                                <div className="flex-1 flex flex-col sm:flex-row gap-3 items-end w-full">
                                    <div className="flex-1 w-full">
                                    ...
                                    <div className="flex-1 flex flex-col gap-1 w-full">
                                        <BaseDateInput
                                            name="taxCertificate.expiryDate"
                                            label="Expiry Date"
                                        />
                                    </div>
                                </div>
                            ...
                            <div className="flex flex-col md:flex-row items-start gap-4">
                                ...
                                <div className="flex-1 flex flex-col sm:flex-row gap-3 items-end w-full">
                                    ...
                                    <div className="flex-1 flex flex-col gap-1 w-full">
                                        <BaseDateInput
                                            name="vatCertificate.expiryDate"
                                            label="Expiry Date"
                                        />
                                    </div>
                                </div>
