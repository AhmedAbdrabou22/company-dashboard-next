...
const MOCK_COUNTRIES: Country[] = [
    { id: 1, name: "Zone 1", code: "KSA", currency: "RSA", status: "Active" },
    { id: 2, name: "Zone 2", code: "EG", currency: "EGP", status: "Inactive" },
    { id: 3, name: "Zone 3", code: "UAE", currency: "DAE", status: "Inactive" },
    { id: 4, name: "Zone 4", code: "OM", currency: "OAE", status: "Inactive" },
];
...
function MainZones() {
    ...
    return (
        <>
            ...
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6 pb-4">
                <PageHeader title="Zones" order="title-first" />
                <AddButton
                    action={() => {
            ...
            <ModalTemplate  
                ...
                title={Object.keys(countryData).length ? `Edit — ${countryData.name}` : "Add New Zone"}
                subtitle=""
                width="sm:max-w-2xl"
            >
                <AddUserCountryForm
